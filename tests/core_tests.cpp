...
int main(){test_version();test_diagnostics();test_ir();test_world_determinism();test_biomes_water_and_streaming();test_scene_graph();test_lighting();test_language_pipeline();test_runtime();test_geometry();test_characters();test_materials();test_textures();test_resources_and_runtime_materials();test_engine();return 0;}
