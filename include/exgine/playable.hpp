...
struct PlayableConfig { RenderConfig render{}; QualitySettings quality{}; std::uint32_t history_width=1280,history_height=720; };
struct PlayableFrame { bool updated=false,render_frame_valid=false,temporal_history_valid=false,nextgen_render_valid=false; std::uint64_t frame_id=0; };
class PlayableGame {
public:
    ...
    [[nodiscard]] const NextGenRuntime& nextgen() const noexcept{return nextgen_;}
